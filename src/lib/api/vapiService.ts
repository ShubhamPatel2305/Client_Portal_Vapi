...
export interface Analytics {
  ...
  callDistribution: Array<{ name: string; value: number }>;
  costAnalysis: Array<{ date: string; value: number }>;
  monthlyCallData: Array<{ date: string; value: number }>;
  recentCalls: Call[];
}
...
export const vapiService = {
  async getAnalytics(startDate?: Date, endDate?: Date): Promise<Analytics> {
    try {
      ...
      return {
        totalCallMinutes,
        totalCallMinutesTrend: { value: totalCallMinutesTrend, label: 'vs last period' },
        numberOfCalls: currentCalls,
        numberOfCallsTrend: { value: numberOfCallsTrend, label: 'vs last period' },
        totalSpent: currentCost,
        totalSpentTrend: { value: totalSpentTrend, label: 'vs last period' },
        avgCostPerCall: currentAvgCost,
        avgCostPerCallTrend: { value: avgCostPerCallTrend, label: 'vs last period' },
        callDistribution,
        costAnalysis,
        monthlyCallData,
        recentCalls: []
